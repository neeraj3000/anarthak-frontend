...
export const COLLECTIONS = [
  ...
  },
  {
    id: "col-graphics",
    slug: "graphics",
    categoryFilter: "Graphic Tees",
    title: "ANARTHAK MANIFESTO GRAPHICS",
    subtitle: "High-density puff ink & Devanagari brutalist art",
    description: "Limited print runs bearing our core philosophy: 'अनर्थक — NOT LIKE THEM'.",
    badge: "LIMITED NUMBERED",
    itemCount: 2,
    heroImage: "https://images.unsplash.com/photo-1576566588028-4147f3842f27?q=80&w=1400&auto=format&fit=crop"
  },
  {
    id: "col-acid",
    slug: "acid-wash",
